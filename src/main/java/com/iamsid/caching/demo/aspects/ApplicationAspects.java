package com.iamsid.caching.demo.aspects;

import com.iamsid.caching.demo.model.TenantContext;
import com.iamsid.caching.demo.tenant.service.AbstractService;
...
public class ApplicationAspects {
    @Before(value = "execution(* com.iamsid.caching.demo.tenant.service..*.*(..)) && target(abstractService)")
    ...
    @After(value = "execution(* com.iamsid.caching.demo.tenant.service..*.*(..)) && target(abstractService)")
